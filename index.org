...
|-------------+-------------------------+------------------------------------|
| TypeScript  | =NPM_TOKEN=             | npm automation token               |
| Kotlin      | =MAVEN_GPG_PRIVATE_KEY= | GPG key for signing                |
|             | =MAVEN_GPG_PASSPHRASE=  | GPG key passphrase                 |
|             | =OSSRH_USERNAME=        | Sonatype OSSRH username            |
|             | =OSSRH_TOKEN=           | Sonatype OSSRH token               |
| C♯          | =NUGET_API_KEY=         | NuGet.org API key                  |
| F♯          | =NUGET_API_KEY=         | NuGet.org API key                  |
